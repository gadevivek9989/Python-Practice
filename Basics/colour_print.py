...
#be carefull that in line 17 we did'nt mentioned green but it prints out in green it will be uneffected until we cancel the colour
...
def colour_print(text: str,effect: str) -> None:
    ...
    """
    out_string = '{0}{1}{2}'.format(effect, text , RESET)
    print(out_string)
